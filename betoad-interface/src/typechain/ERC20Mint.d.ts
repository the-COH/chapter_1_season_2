...
interface ERC20MintInterface extends ethers.utils.Interface {
  functions: {
    ...
    "minterIndex(address)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "minterIndex", values: [string]): string;
  encodeFunctionData(
...
export class ERC20Mint extends BaseContract {
  ...
  functions: {
    ...
    minterIndex(arg0: string, overrides?: CallOverrides): Promise<[BigNumber]>;
