...
interface BaseV1PairInterface extends ethers.utils.Interface {
  functions: {
    ...
    "totalSupplyAvg(uint256)": FunctionFragment;
    "totalSupplyCumulativeLast()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "totalSupplyAvg",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "totalSupplyCumulativeLast",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class BaseV1Pair extends BaseContract {
  ...
  functions: {
    ...
    lastObservation(
      ...
      [
        [BigNumber, BigNumber, BigNumber, BigNumber] & {
          ...
          reserve0Cumulative: BigNumber;
          reserve1Cumulative: BigNumber;
          totalSupplyCumulative: BigNumber;
        }
      ]
    >;
    ...
    totalSupplyCumulativeLast(overrides?: CallOverrides): Promise<[BigNumber]>;
