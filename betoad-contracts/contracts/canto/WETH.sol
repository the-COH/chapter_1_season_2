...
contract WETH is EIP20Interface {
    ...
    function withdraw(uint256 wamount) public {
        require(
            _balanceOf[msg.sender] >= wamount,
            "sender balance insufficient for withdrawal"
        );
        _balanceOf[msg.sender] -= wamount;
    ...
    function transferFrom(
        ...
        require(
            _balanceOf[src] >= wad,
            "WETH::transfeFrom: balance insufficient"
        );
        ...
        if (
            ...
            require(
                ...
                "WETH::transferFrom:allowance insufficient"
            );
            _allowance[src][msg.sender] -= wad;
        }
